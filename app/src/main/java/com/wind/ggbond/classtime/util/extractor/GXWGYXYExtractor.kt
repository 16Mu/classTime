 ...
 * 广西外国语学院课表提取器
 * 系统：新正方教务系统
 * 参考：temp_aishedule/正方教务/新正方教务/广西外国语学院/Provider.js
 */
@Singleton
class GXWGYXYExtractor @Inject constructor() : SchoolScheduleExtractor {
    ...
    override fun parseCourses(jsonData: String): List<ParsedCourse> {
        ...
        try {
            AppLogger.d(TAG, "开始解析广西外国语学院课程数据...")

...
@Singleton
class CJDXExtractor @Inject constructor() : SchoolScheduleExtractor {
    override val schoolId = "cjdx"
    override val schoolName = "长江大学"
    override val systemType = "shuwei"

    override val aliases = listOf("长江大学", "长大")
    override val supportedUrls = listOf("jw.yangtzeu.edu.cn")
    companion object { private const val TAG = "CJDXExtractor" }
    ...
    override fun getLoginUrl() = "http://jw.yangtzeu.edu.cn/"
    override fun getScheduleUrl() = "http://jw.yangtzeu.edu.cn/eams/courseTableForStd.action"
    
    override fun generateExtractionScript() = """
        (function() {
            try {
                console.log('🔍 开始提取长江大学课表（树维系统-版本一）...');
                var courses = [];

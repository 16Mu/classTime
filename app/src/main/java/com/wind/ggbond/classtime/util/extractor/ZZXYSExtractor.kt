...
@Singleton
class ZZXYSExtractor @Inject constructor() : SchoolScheduleExtractor {
    override val schoolId = "zzxys"
    override val schoolName = "郑州西亚斯学院"
    override val systemType = "shuwei"

    override val aliases = listOf("郑州西亚斯学院", "郑州西亚斯", "西亚斯")
    override val supportedUrls = listOf("ems.sias.edu.cn")
    companion object { private const val TAG = "ZZXYSExtractor" }
    ...
    override fun getLoginUrl() = "http://ems.sias.edu.cn/"
    override fun getScheduleUrl() = "http://ems.sias.edu.cn/eams/courseTableForStd.action"
    
    override fun generateExtractionScript() = """
        (function() {
            try {
                console.log('🔍 开始提取郑州西亚斯学院课表（树维系统-版本一）...');
                var courses = [];

...
@Singleton
class LNZBZZZYJSXYExtractor @Inject constructor() : SchoolScheduleExtractor {
    override val schoolId = "lnzbzzzyjsxy"
    override val schoolName = "辽宁装备制造职业技术学院"
    override val systemType = "shuwei"

    override val aliases = listOf("辽宁装备制造职业技术学院", "辽装院")
    override val supportedUrls = listOf("xsc.ltcem.com")
    companion object { private const val TAG = "LNZBZZZYJSXYExtractor" }
    ...
    override fun getLoginUrl() = "http://xsc.ltcem.com/"
    override fun getScheduleUrl() = "http://xsc.ltcem.com/eams/courseTableForStd.action"
    
    override fun generateExtractionScript() = """
        (function() {
            try {
                console.log('🔍 开始提取辽宁装备制造职业技术学院课表（树维系统-版本一）...');
                var courses = [];

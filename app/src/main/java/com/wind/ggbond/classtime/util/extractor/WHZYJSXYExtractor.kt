...
@Singleton
class WHZYJSXYExtractor @Inject constructor() : SchoolScheduleExtractor {
    override val schoolId = "whzyjsxy"
    override val schoolName = "武汉职业技术学院"
    override val systemType = "shuwei"

    override val aliases = listOf("武汉职业技术学院", "武职")
    override val supportedUrls = listOf("jxgl.wtc.edu.cn")
    companion object { private const val TAG = "WHZYJSXYExtractor" }
    ...
    override fun getLoginUrl() = "http://jxgl.wtc.edu.cn/"
    override fun getScheduleUrl() = "http://jxgl.wtc.edu.cn/eams/courseTableForStd.action"
    
    override fun generateExtractionScript() = """
        (function() {
            try {
                console.log('🔍 开始提取武汉职业技术学院课表（树维系统-版本一）...');
                var courses = [];

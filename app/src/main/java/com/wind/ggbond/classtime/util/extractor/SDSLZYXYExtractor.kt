...
@Singleton
class SDSLZYXYExtractor @Inject constructor() : SchoolScheduleExtractor {
    override val schoolId = "sdslzyxy"
    override val schoolName = "山东水利职业学院"
    override val systemType = "shuwei"

    override val aliases = listOf("山东水利职业学院", "山水院")
    override val supportedUrls = listOf("jw.sdwcvc.edu.cn")
    companion object { private const val TAG = "SDSLZYXYExtractor" }
    ...
    override fun getLoginUrl() = "http://jw.sdwcvc.edu.cn/"
    override fun getScheduleUrl() = "http://jw.sdwcvc.edu.cn/eams/courseTableForStd.action"
    
    override fun generateExtractionScript() = """
        (function() {
            try {
                console.log('🔍 开始提取山东水利职业学院课表（树维系统-版本一）...');
                var courses = [];

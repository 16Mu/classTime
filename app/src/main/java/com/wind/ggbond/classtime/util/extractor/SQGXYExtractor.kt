...
@Singleton
class SQGXYExtractor @Inject constructor() : SchoolScheduleExtractor {
    override val schoolId = "sqgxy"
    override val schoolName = "商丘工学院"
    override val systemType = "shuwei"

    override val aliases = listOf("商丘工学院", "商工")
    override val supportedUrls = listOf("jwgl.sqgxy.edu.cn")
    companion object { private const val TAG = "SQGXYExtractor" }
    ...
    override fun getLoginUrl() = "http://jwgl.sqgxy.edu.cn/"
    override fun getScheduleUrl() = "http://jwgl.sqgxy.edu.cn/eams/courseTableForStd.action"
    
    override fun generateExtractionScript() = """
        (function() {
            try {
                console.log('🔍 开始提取商丘工学院课表（树维系统-版本一）...');
                var courses = [];

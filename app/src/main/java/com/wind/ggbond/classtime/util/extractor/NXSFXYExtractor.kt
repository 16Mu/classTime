 ...
 * 宁夏师范学院课表提取器
 * 系统：新正方教务系统
 * 参考：temp_aishedule/正方教务/新正方教务/宁夏师范学院/provider.js
 */
@Singleton
class NXSFXYExtractor @Inject constructor() : SchoolScheduleExtractor {
    
    override val schoolId = "nxsfxy"
    override val schoolName = "宁夏师范学院"
    override val systemType = "zfsoft"

    override val aliases = listOf("宁夏师范学院")
    override val supportedUrls = listOf("jwgl.nxnu.edu.cn")
    
    companion object {
        private const val TAG = "NXSFXYExtractor"
    }
    ...
    override fun parseCourses(jsonData: String): List<ParsedCourse> {
        ...
        try {
            AppLogger.d(TAG, "开始解析宁夏师范学院课程数据...")

 ...
 * 湖北交通职业技术学院课表提取器
 * 系统：新正方教务系统（有Ajax）
 * 参考：temp_aishedule/正方教务/新正方教务/湖北交通职业技术学院_有ajax/provider.js
 */
@Singleton
class HBJTZYJSXYExtractor @Inject constructor() : SchoolScheduleExtractor {
    
    override val schoolId = "hbjtxzyjsxy"
    override val schoolName = "湖北交通职业技术学院"
    override val systemType = "zfsoft"
    
    companion object {
        private const val TAG = "HBJTZYJSXYExtractor"
    }
    ...
    override fun parseCourses(jsonData: String): List<ParsedCourse> {
        ...
        try {
            AppLogger.d(TAG, "开始解析湖北交通职业技术学院课程数据...")

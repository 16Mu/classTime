...
@Singleton
class ZZDXExtractor @Inject constructor() : SchoolScheduleExtractor {
    override val schoolId = "zzdx"
    override val schoolName = "郑州大学"
    override val systemType = "shuwei"

    override val aliases = listOf("郑州大学", "郑大")
    override val supportedUrls = listOf("jw.zzu.edu.cn")
    companion object { private const val TAG = "ZZDXExtractor" }
    ...
    override fun getLoginUrl() = "http://jw.zzu.edu.cn/"
    override fun getScheduleUrl() = "http://jw.zzu.edu.cn/eams/courseTableForStd.action"
    
    override fun generateExtractionScript() = """
        (function() {
            try {
                console.log('🔍 开始提取郑州大学课表（树维系统-版本一）...');
                var courses = [];

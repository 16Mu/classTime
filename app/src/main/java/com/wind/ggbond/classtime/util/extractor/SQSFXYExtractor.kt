...
@Singleton
class SQSFXYExtractor @Inject constructor() : SchoolScheduleExtractor {
    override val schoolId = "sqsfxy"
    override val schoolName = "商丘师范学院"
    override val systemType = "shuwei"

    override val aliases = listOf("商丘师范学院", "商师")
    override val supportedUrls = listOf("jw.sqnu.edu.cn")
    companion object { private const val TAG = "SQSFXYExtractor" }
    ...
    override fun getLoginUrl() = "http://jw.sqnu.edu.cn/"
    override fun getScheduleUrl() = "http://jw.sqnu.edu.cn/eams/courseTableForStd.action"
    
    override fun generateExtractionScript() = """
        (function() {
            try {
                console.log('🔍 开始提取商丘师范学院课表（树维系统-版本一）...');
                var courses = [];

...
@Singleton
class HNLGDXExtractor @Inject constructor() : SchoolScheduleExtractor {
    override val schoolId = "hnlgdx"
    override val schoolName = "河南理工大学"
    override val systemType = "shuwei"

    override val aliases = listOf("河南理工大学", "河理工")
    override val supportedUrls = listOf("adms.hpu.edu.cn")
    companion object { private const val TAG = "HNLGDXExtractor" }
    ...
    override fun getLoginUrl() = "http://adms.hpu.edu.cn/"
    override fun getScheduleUrl() = "http://adms.hpu.edu.cn/eams/courseTableForStd.action"
    
    override fun generateExtractionScript() = """
        (function() {
            try {
                console.log('🔍 开始提取河南理工大学课表（树维系统-版本一）...');
                var courses = [];

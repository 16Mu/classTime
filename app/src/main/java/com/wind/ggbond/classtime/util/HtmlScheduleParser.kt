...
class HtmlScheduleParser @Inject constructor() {
    ...
    private fun cleanCourseName(rawName: String): String {
        ...
        val schoolNamePatterns = listOf(
            Regex("""^[^\s]*高等专科学校\s*"""),  // "XX高等专科学校" 或 "XX高等专科学校 "
            Regex("""^[^\s]*职业技术大学\s*"""),  // "XX职业技术大学" 或 "XX职业技术大学 "
            Regex("""^[^\s]*职业技术学院\s*"""),  // "XX职业技术学院" 或 "XX职业技术学院 "
            Regex("""^[^\s]*专科学校\s*"""),  // "XX专科学校" 或 "XX专科学校 "
            Regex("""^[^\s]*职业大学\s*"""),  // "XX职业大学" 或 "XX职业大学 "
            Regex("""^[^\s]*大学\s*"""),  // "XX大学" 或 "XX大学 "
            Regex("""^[^\s]*学院\s*"""),  // "XX学院" 或 "XX学院 "
        )

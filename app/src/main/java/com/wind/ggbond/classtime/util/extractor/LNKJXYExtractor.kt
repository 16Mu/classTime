...
@Singleton
class LNKJXYExtractor @Inject constructor() : SchoolScheduleExtractor {
    override val schoolId = "lnkjxy"
    override val schoolName = "辽宁科技学院"
    override val systemType = "shuwei"

    override val aliases = listOf("辽宁科技学院", "辽科院")
    override val supportedUrls = listOf("jwc.lnist.edu.cn")
    companion object { private const val TAG = "LNKJXYExtractor" }
    ...
    override fun getLoginUrl() = "http://jwc.lnist.edu.cn/"
    override fun getScheduleUrl() = "http://jwc.lnist.edu.cn/eams/courseTableForStd.action"
    
    override fun generateExtractionScript() = """
        (function() {
            try {
                console.log('🔍 开始提取辽宁科技学院课表（树维系统-版本一）...');
                var courses = [];

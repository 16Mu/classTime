 ...
 * 武汉大学课表提取器
 * 系统：新正方教务系统
 * 参考：temp_aishedule/正方教务/新正方教务/武汉大学/provider.js
 */
@Singleton
class WHDXExtractor @Inject constructor() : SchoolScheduleExtractor {
    ...
    companion object {
        private const val TAG = "WHDXExtractor"
    }

...
@Singleton
class AHKJXYExtractor @Inject constructor() : SchoolScheduleExtractor {
    ...
    override fun getLoginUrl() = "http://jw.ahstu.edu.cn/"
    override fun getScheduleUrl() = "http://jw.ahstu.edu.cn/eams/courseTableForStd.action"
    
    override fun generateExtractionScript() = """
        (function() {
            try {
                console.log('🔍 开始提取安徽科技学院课表（树维系统-版本一）...');
                var courses = [];

 ...
 * 参考：temp_aishedule/树维/内蒙古财经大学/provider.js
 */
@Singleton
class NMGCJDXExtractor @Inject constructor() : SchoolScheduleExtractor {
    
    override val schoolId = "nmgcjdx"
    override val schoolName = "内蒙古财经大学"
    override val systemType = "shuwei"

    override val aliases = listOf("内蒙古财经大学", "内财大")
    override val supportedUrls = listOf("jwxt.imufe.edu.cn")
    
    companion object {
        private const val TAG = "NMGCJDXExtractor"
    }
    ...
    override fun getLoginUrl(): String = "http://jwxt.imufe.edu.cn/"
    override fun getScheduleUrl(): String = "http://jwxt.imufe.edu.cn/eams/courseTableForStd.action"
    
    override fun generateExtractionScript(): String {
        return """
            (function() {
                try {
                    console.log('🔍 开始提取内蒙古财经大学课表（树维系统-版本一）...');
                    var courses = [];

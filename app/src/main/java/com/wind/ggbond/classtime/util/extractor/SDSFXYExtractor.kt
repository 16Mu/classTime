 ...
 * 山东师范大学课表提取器
 * 系统：新正方教务系统
 * 参考：temp_aishedule/正方教务/新正方教务/山东师范大学/provider.js
 */
@Singleton
class SDSFXYExtractor @Inject constructor() : SchoolScheduleExtractor {
    ...
    companion object {
        private const val TAG = "SDSFXYExtractor"
    }
    ...
    override fun parseCourses(jsonData: String): List<ParsedCourse> {
        ...
        try {
            AppLogger.d(TAG, "开始解析山东师范大学课程数据...")
